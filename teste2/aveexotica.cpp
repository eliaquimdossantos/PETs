...
AveExotica::AveExotica(string uf_origem_, string ibama_, 
		int tamanho_bico_, int envergadura_, int id_, 
		...
		Ave(tamanho_bico_, envergadura_, id_, classe_, nome_ ,cientifico_, sexo_, tamanho_, dieta_, veterinario_, tratador_, batismo_){
